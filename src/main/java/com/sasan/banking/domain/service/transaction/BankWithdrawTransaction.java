...
public class BankWithdrawTransaction  implements BankTransaction {
    private final BankAccountRepository repository;
    private final AccountNumber accountNumber;
    private final Money amount;

    public BankWithdrawTransaction(BankAccountRepository repository, AccountNumber accountNumber, Money amount) {
